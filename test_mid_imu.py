...
import time
import torch
from data_helper_mid import get_data_info, ImageSequenceDataset
...
if __name__ == '__main__':
    ...
    for i in range(12,17):
        videos_to_test.append(str(i).zfill(2))
    # videos_to_test = ['02','04','06','08','10']#['09','05','11','13']  # ['00', '01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12', '13', '14', '15', '16']
    ...
    for test_video in videos_to_test:
        ...
        for i, batch in enumerate(dataloader):
            ...
            if use_cuda:
                ...
                imu = imu.cuda()
                y = y.cuda()
            batch_predict_pose = M_deepvo.forward(x,imu)
