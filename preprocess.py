...
def create_pose_data():
	...
	# info = {'00': [0, 2204], '01': [0, 2204], '02': [0, 2201], '03': [0, 2204], '04': [0, 2231], '05': [0, 2205], '06': [0, 2205], '07': [0, 2203], '08': [0, 2204], '09': [0, 2208], '10': [0, 2206],'11': [0,2208], '12': [0,2204], '13': [0,2205], '14': [0,2210], '15': [0,2199], '16': [0,2199]}
	info = list(range(0,29))
	start_t = time.time()
	# for video in info.keys():
	for video in info:
		fn = '{0}{1:02d}.txt'.format(par.pose_dir, video)
...
if __name__ == '__main__':
	...
	# train_video = ['00', '01', '02','03','04', '05','06','07', '08', '09','10','11']
	# image_path_list = []
	# for folder in train_video:
	# 	image_path_list += glob.glob('/media/ssy/seungyeon/dataset/MidAir/Kite_training/sunny/images/{}/*.JPEG'.format(folder))
